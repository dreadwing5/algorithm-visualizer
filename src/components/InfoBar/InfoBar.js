    ...
    description: (
      <div>
        <p>
          ...
          algorithm, meaning that the relative positioning of equal sort items
          is not preserved.Quicksort is a divide and conquer algorithm.
        ...
        <ol>
          ...
          <li>
            ...
            with values greater than the pivot come after it (equal values can
